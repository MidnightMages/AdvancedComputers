...
public class MainboardProgrammerBlockScreen extends AbstractContainerScreen<MainboardProgrammerBlockMenu> {
    ...
    public MainboardProgrammerBlockScreen(MainboardProgrammerBlockMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
