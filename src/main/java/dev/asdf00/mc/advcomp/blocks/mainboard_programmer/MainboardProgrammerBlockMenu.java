...
public class MainboardProgrammerBlockMenu extends AbstractContainerMenu {
    public final MainboardProgrammerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public MainboardProgrammerBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public MainboardProgrammerBlockMenu(int pContainerId, Inventory playerInv, BlockEntity be, ContainerData cd) {
        super(AdvancedComputers.MAINBOARD_PROGRAMMER_MENU.get(), pContainerId);
        checkContainerSize(playerInv, TE_INVENTORY_SLOT_COUNT);
        blockEntity = (MainboardProgrammerBlockEntity) be;
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, AdvancedComputers.MAINBOARD_PROGRAMMER_BLOCK.block().get());
    }
}
